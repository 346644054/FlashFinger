    ...
    var t = {
            ...
            setcss: function () {
                ...
                function e(t) {
                    ...
                    if (t in e) return t;
                    for (var s, r = i.length, n = t.charAt(0).toUpperCase() + t.slice(1); r--;)
                ...
                return function (t, e) {
                    var s, i, n = arguments;
                    if (2 == n.length)
                        for (s in e) i = e[s], void 0 !== i && e.hasOwnProperty(s) && r(t, s, i);
                    else r(t, n[1], n[2])
                }
            }(),
        ...
        return d.prototype = {
                ...
                start: function () {
                    ...
                    if (this._isBufferStyle() && !this.bufferStatus) {
                        ...
                        e.hideEl(o), e.hideEl(n), this.setBuffer(0).setBuffer(1), setTimeout(function () {
                    ...
                    if (this._isIndeterminateStyle()) return !this._isRendered() && t && (this.set(0), o = this._getRenderedId(), n = r), e.setcss(o, {
                        transition: "none",
                        opacity: 1
                    ...
                    if (this._isQueryStyle()) {
                        if (this._isRendered()) {
                            ...
                            return e.addClass(a, "end"), setTimeout(function () {
                                s._remove()
                            }, i), this
                        }
                        if (t) return this.set(0), o = this._getRenderedId(), setTimeout(function () {
                            s._remove()
                        }, i), this
                    }
                ...
                inc: function (t) {
                    var e = this.status,
                        s = this.bufferStatus;
                    return e ? (e = this._getRandomNum(e, t), this._isBufferStyle() && (s = this._getRandomNum(s > e ? s : e + .1, t), this.setBuffer(s)), this.set(e)) : this.start()
                },
                _trickle: function () {
                ...
                _setProgress: function (t, s) {
                    var r = this._render(),
                        ...
                        a = this;
                    return r.offsetWidth, this._isIndeterminateStyle() || this._isQueryStyle() ? this : void e.queue(function (t) {
                        "" === a.options.positionUsing && (a.options.positionUsing = a._getPositioningCSS()), e.setcss(i, a._barPositionCSS(s, n, o)), 1 === s ? (e.setcss(r, {
                            transition: "none",
                            opacity: 1
                ...
                _getRandomNum: function (t, s) {
                    return "number" != typeof s && (s = (1 - t) * e.clamp(Math.random() * t, .1, .95)), t = e.clamp(t + s, 0, .994)
                },
                ...
                _getCurrTemplate: function () {
                    var t, e = this.options.template || 1,
                ...
                _barPositionCSS: function (t, s, r) {
                    var i;
                    return i = "translate3d" === this.options.positionUsing ? {
            ...
            function () {
                ...
                d.prototype.promise = function (s) {
                    ...
                    var r = this;
                    return 0 == e && r.start(), t++, e++, s.always(function () {
